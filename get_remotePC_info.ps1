        ...
        try {
            ...
            if (Test-Connection -ComputerName $computerName -Count 3 -Quiet){
                ...
                ForEach ($CurrentUser in $CUser){
                    ...
                    $UserName = $CurrentUser.UserName -Replace "DOMAIN\\", ""
                    ...
                    if ($UserName -ne ""){
                        $ADUser = Get-ADUser -Filter "mailNickname -like '*$UserName*'" -properties *
                            ...
                            ForEach ($ADOUnits in $ADOUnit){
                                $DName = $ADOUnits.CanonicalName -Replace "sample.com.ph/SAMPLE/",""
                ...
                try {
                    ...
                    $MonitorInfoCSV = Import-CSV -Path "C:\REMOTEPC\resources\MonitorDB.csv" #the path of the monitor assets details
